...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [3,1,4,2]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [-1,3,2,0]
<strong>Output:</strong> true
