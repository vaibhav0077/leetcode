...
<pre style="background-color: rgb(193, 230, 198);">int[] nums = [...]; // Input array
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [1,1,1,2,2,3]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [0,0,1,1,1,1,2,3,3]
