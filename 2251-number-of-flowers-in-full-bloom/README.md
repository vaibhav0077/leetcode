...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> flowers = [[1,6],[3,7],[9,12],[4,13]], poeple = [2,3,7,11]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> flowers = [[1,10],[3,3]], poeple = [3,3,2]
