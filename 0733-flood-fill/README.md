...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> image = [[1,1,1],[1,1,0],[1,0,1]], sr = 1, sc = 1, color = 2
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> image = [[0,0,0],[0,0,0]], sr = 0, sc = 0, color = 0
