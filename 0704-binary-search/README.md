...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [-1,0,3,5,9,12], target = 9
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums = [-1,0,3,5,9,12], target = 2
