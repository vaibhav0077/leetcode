...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums1 = [2,1,-2,5], nums2 = [3,0,-6]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums1 = [3,-2], nums2 = [2,-6,7]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> nums1 = [-1,-1], nums2 = [1,1]
