...
<pre style="background-color: rgb(193, 230, 198);">F(0) = 0, F(1) = 1
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> n = 2
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> n = 3
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> n = 4
