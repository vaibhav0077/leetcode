...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> colors = "AAABABB"
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> colors = "AA"
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> colors = "ABBBBBBBAAA"
<strong>Output:</strong> false
<strong>Explanation:</strong>
