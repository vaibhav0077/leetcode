...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> words = ["i","love","leetcode","i","love","coding"], k = 2
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> words = ["the","day","is","sunny","the","the","the","sunny","is","is"], k = 4
