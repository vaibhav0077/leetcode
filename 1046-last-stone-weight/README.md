...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> stones = [2,7,4,1,8,1]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> stones = [1]
<strong>Output:</strong> 1
</pre>
