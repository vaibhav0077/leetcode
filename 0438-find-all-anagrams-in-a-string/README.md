...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = "cbaebabacd", p = "abc"
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> s = "abab", p = "ab"
